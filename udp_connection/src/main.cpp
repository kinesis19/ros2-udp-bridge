...
int main(int argc, char* argv[])
{
  ...
  std::shared_ptr<StmSerialNode> stm_serial_node = nullptr;
  ...
  if (deviceType == "laptop") {
    ...
    stm_serial_node = std::make_shared<StmSerialNode>();

    stm_serial_node->start();

    window = new JetsonWindow(stm_serial_node);
  } else {
